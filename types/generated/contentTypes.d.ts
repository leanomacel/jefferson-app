...
export interface ApiConfigConfig extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    nome_sistema: Schema.Attribute.String;
    publishedAt: Schema.Attribute.DateTime;
    table_colors: Schema.Attribute.JSON;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
export interface ApiProjetoProjeto extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    gerente: Schema.Attribute.Relation<'manyToOne', 'api::gerente.gerente'>;
    ...
    pagamento_1_parcela: Schema.Attribute.Date;
    proponente: Schema.Attribute.Relation<
      'manyToOne',
      'api::proponente.proponente'
    >;
    publishedAt: Schema.Attribute.DateTime;
    situacao: Schema.Attribute.Relation<'manyToOne', 'api::situacao.situacao'>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiProponenteProponente extends Struct.CollectionTypeSchema {
  collectionName: 'proponentes';
  info: {
    displayName: 'Proponente';
    pluralName: 'proponentes';
    singularName: 'proponente';
  };
  options: {
    draftAndPublish: false;
  };
...
export interface ApiSituacaoSituacao extends Struct.CollectionTypeSchema {
  collectionName: 'situacoes';
  info: {
    displayName: 'Situa\u00E7\u00E3o';
    pluralName: 'situacoes';
    singularName: 'situacao';
  };
  options: {
    draftAndPublish: false;
  };
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::proponente.proponente': ApiProponenteProponente;
      'api::situacao.situacao': ApiSituacaoSituacao;
